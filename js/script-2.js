  ...
  meals.forEach((meal) => {
    blackbox = `
           <div class="main-inner">
               <div class="solid__item" onclick="displayCountry('${meal.strArea}')">
...
// show inside area (country) when i click on it  /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/
...
async function getAllCategories() {
  try {
    ...
    if (categories) {
      ...
      $("#main-body .row").html("<p>No categories found.</p>");
    }
  } catch (error) {
    console.log(error);
  }
...
function displayCategoryItem(categories) {
  categories.forEach((category) => {
    let blackbox = `<div class="main-inner g-3">
                              <div class="catg__item" onclick="filterCategory('${
...
async function getAllIngredients() {
  try {
    ...
    if (ingredients) {
      ...
      $("#main-body .row").html("<p>No ingredients found.</p>");
    }
  } catch (error) {
    console.log(error);
  }
...
function displayingredientItem(ingredients) {
  ...
  ingredients.forEach((ingredient) => {
    blackbox = `
           <div class="main-inner">
               <div class="solid__item" onclick="filterIngredient('${
...
async function searchByName(input) {
  $(".second-loading-screen").fadeIn(300);
  $("#search").removeClass("bgcolor-red");
  let res = await fetch(
